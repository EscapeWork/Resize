...
class Redimensiona {
    ...
    //construtor
    public function Redimensiona( $origem = '', $extensoes_validas = array( 'jpg', 'jpeg', 'jpe', 'gif', 'bmp', 'png' ) ) {
...
// funções para redimensionamento
     ...
     * @return Boolean/void
    */  
    public function redimensionar( $nova_largura = 0, $nova_altura = 0, $tipo = '', $rgb = array( 255,255,255 ) ) 
    {
    ...
    public function grava( $destino='', $qualidade=100 ) 
    {
        ...
        switch( $extensao_destino )
        {
            ...
            case 'bmp':
                if ( $destino ) 
                {
                    $foto = imagejpeg( $this->img, $destino, $qualidade );
                    return $foto;
                } 
                else 
                {
